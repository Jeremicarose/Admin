    ...
    AccessControlUpgradeable
{
    ...
    modifier onlyManager() {
        require(hasRole(MANAGER, msg.sender), "Only manager can call this function");
        _;
    }
    ...
    function grantManagerRole(address _address) public onlyManager {
        grantRole(MANAGER, _address);
    }

    function revokeManagerRole(address _address) public onlyManager {
        revokeRole(MANAGER, _address);
    }

    function renounceManagerRole() public onlyManager {
        renounceRole(MANAGER, msg.sender);
    }
